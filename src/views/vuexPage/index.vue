<template>
  <div class="helloVuex">
    ...
    <hr />
    <h2>Vuex详解，一文彻底搞懂Vuex</h2>
    <a href="https://blog.csdn.net/qq_56989560/article/details/124706021" target="blank">参考连接</a>
    <h2>vuex页面刷新数据丢失问题的四种解决方式</h2>
    <a href="https://blog.csdn.net/bidepanm/article/details/124686409" target="blank">参考连接</a>
    <hr />
    <h2>State</h2>
    ...
    <p>
      ...
      <el-button type="priamry">123</el-button>
    </p>
  </div>
</template>
